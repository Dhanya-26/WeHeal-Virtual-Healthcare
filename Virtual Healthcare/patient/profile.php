            ...
            <div class="w3-container">
                ...
                <h3><?php
                    ...
                    while ($row = mysqli_fetch_array($edit_run_fname_query)) {
                        ...
                        echo $row ['l_name'];
                        echo "  ";
                        echo "<a href=u_fl_name.php>edit</a><br />";

                        echo "Email Address :  ";
                        echo $row['email'];
                        echo "  ";
                        echo "<a href=u_email.php>edit</a><br />";
                        echo "Contact Number :  ";
                        echo $row['contact'];
                        echo "  ";
                        echo "<a href=u_contact.php>edit</a><br />";
                        echo "Address :  ";
                        echo $row['address'];
                        echo "  ";
                        echo "<a href=u_address.php>edit</a><br />";
                        echo "Change Password :  ";
                        echo "  ";
                        echo "<a href=u_pswd.php>edit</a><br />";
                    }
